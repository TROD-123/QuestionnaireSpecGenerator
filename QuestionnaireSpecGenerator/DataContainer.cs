    ...
    public class DataContainer
    {
        ...
        public void AddChild<T>(T child, int position) where T : QreObjBase
        {
            try
            {
                ...
                if (!type.Equals(QreObjTypes.Response)) {
        ...
        private int GenerateRandomId(QreObjTypes type)
        {
            ...
            {
                Console.WriteLine(Toolbox.GenerateConsoleErrorMessage("DataContainer.GenerateRandomId", e, "-1"));
                return -1;
            }
        }
