...
namespace QuestionnaireSpecGenerator
{
        ...
        where T : QreObjBase
    {
        ...
        /// <summary>
        /// Changes the position of the specified Child object. Throws an exception if Child does not exist, or if position
        /// is invalid.
        /// </summary>
        /// <param name="child">The child.</param>
        /// <param name="newPosition">The new position.</param>
        public void ChangePosition(T child, int newPosition)
        {
            // TODO: Test the below
            try
            {
                RemoveChild(child);
                AddChild(child, newPosition);
            } catch (ArgumentOutOfRangeException e)
            {
                // TODO: Handle the error
                Console.WriteLine("ChangePosition threw an exception: " + e + "\n Proceeding...");
            }
        }
